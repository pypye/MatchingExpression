...
void Scene::InitUI(){
    ...
    Game::getInstance().mainMenu.btn            = Graphics::getInstance().loadTexture("MatchingExpression_data\\images\\Button1.bmp", 376, 377);
    ...
    Game::getInstance().mainMenu.textbtn        = Text::getInstance().loadText("Main Menu", "MatchingExpression_data\\fonts\\segoeuisb.ttf", {255, 255, 255}, 17, 423, 390);
    ///ui
    ...
    Game::getInstance().Paused_mainMenu.btn     = Graphics::getInstance().loadTexture("MatchingExpression_data\\images\\Button1.bmp", 269, 394);
    ...
    Game::getInstance().Paused_mainMenu.textbtn = Text::getInstance().loadText("Main Menu", "MatchingExpression_data\\fonts\\segoeuisb.ttf", {255, 255, 255}, 17, 316, 407);
    ///menu scene
    Menu::getInstance().newGame.btn             = Graphics::getInstance().loadTexture("MatchingExpression_data\\images\\button.bmp", 241, 359);
    Menu::getInstance().blindMode.btn           = Graphics::getInstance().loadTexture("MatchingExpression_data\\images\\button.bmp", 241, 430);
    Menu::getInstance().bgm.btn                 = Graphics::getInstance().loadTexture("MatchingExpression_data\\images\\button.bmp", 241, 501);
    Menu::getInstance().quit.btn                = Graphics::getInstance().loadTexture("MatchingExpression_data\\images\\button.bmp", 241, 572);

    Menu::getInstance().newGame.textbtn         = Text::getInstance().loadText("Normal Mode", "MatchingExpression_data\\fonts\\segoeuisb.ttf", {255, 255, 255}, 23, 287, 375);
    Menu::getInstance().blindMode.textbtn       = Text::getInstance().loadText("Blind Mode", "MatchingExpression_data\\fonts\\segoeuisb.ttf", {255, 255, 255}, 23, 300, 446);
    Menu::getInstance().bgm.textbtn             = Text::getInstance().loadText("BGM", "MatchingExpression_data\\fonts\\segoeuisb.ttf", {255, 255, 255}, 23, 336, 517);
    Menu::getInstance().quit.textbtn            = Text::getInstance().loadText("Quit", "MatchingExpression_data\\fonts\\segoeuisb.ttf", {255, 255, 255}, 23, 337, 588);

    Menu::getInstance().intro_ani               = Animation::getInstance().loadAnimation("MatchingExpression_data\\animations\\intro.bmp", 267, 86, 186, 186, 6);
}
void Scene::cleanUp(){
    SDL_DestroyWindow(_window);
    SDL_DestroyRenderer(_renderer);
    Audio::getInstance().saveAudioStatus();
